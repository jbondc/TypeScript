...
module ts {
    export var Diagnostics = {
        ...
        Use_interface_0_instead_of_type_0_to_alias_a_structured_type: { code: 9003, category: DiagnosticCategory.Error, key: "Use 'interface {0} = {}' instead of 'type {0} = {}' to alias a structured type." },
        interface_0_can_only_reference_a_structured_type: { code: 9004, category: DiagnosticCategory.Error, key: "'interface {0} =' can only reference a structured type." },
        interface_0_typeof_1_can_only_reference_a_class_or_interface: { code: 9005, category: DiagnosticCategory.Error, key: "'interface {0} = typeof {1}' can only reference a class or interface." },
    };
}